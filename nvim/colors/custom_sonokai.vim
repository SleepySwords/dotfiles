...
let s:last_modified = 'Thu Nov 11 07:35:15 AM UTC 2021'
...
elseif s:configuration.diagnostic_virtual_text ==# 'colour_background'
  call sonokai#highlight('BgYellow', s:palette.yellow, ['#594d26', 0])
  call sonokai#highlight('BgRed', s:palette.red, ['#4d1c26', 0])
  call sonokai#highlight('BgBlue', s:palette.blue, ['#29464d', 0])
  call sonokai#highlight('BgGreen', s:palette.green, ['#3a4d2a', 0])
  highlight! link VirtualTextWarning BgYellow
  highlight! link VirtualTextError BgRed
  highlight! link VirtualTextInfo BgBlue
  highlight! link VirtualTextHint BgGreen
else

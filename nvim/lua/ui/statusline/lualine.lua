...
local colors = {
	...
	bg           = colour_to_hex(shade(colour_name_to_tuple(vim.api.nvim_get_hl(0, { name = "normal" }).bg), 0.8)),
...
local branch_left = {
	function()
		if vim.b.gitsigns_status_dict.added or vim.b.gitsigns_status_dict.changed or vim.b.gitsigns_status_dict.removed then
			return '('
		end
	end,
	color = { fg = colors.violet, bg = colors.component_bg, gui = 'bold' },

...
map_desc({ 'n' }, '<leader>ci', "<cmd>lua vim.lsp.inlay_hint.enable(0, not vim.lsp.inlay_hint.is_enabled())<CR>", 'LSP Code Action', opts)
...
map_desc({ 'n' }, '<leader>xe', '<cmd>TroubleToggle workspace_diagnostics<CR>', 'Trouble workspace diagnostics', opts)
